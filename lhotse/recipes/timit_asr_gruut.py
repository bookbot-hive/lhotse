...
def download_timit_asr_gruut(
    ...
    corpus_dir = target_dir / "timit_asr_gruut"
    ...
    for split in splits:
        ...
        if output_dir is not None:
            supervision_set.to_file(
                output_dir / f"timit_asr_gruut_supervisions_{split}.jsonl.gz"
            )
            recording_set.to_file(output_dir / f"timit_asr_gruut_recordings_{split}.jsonl.gz")
