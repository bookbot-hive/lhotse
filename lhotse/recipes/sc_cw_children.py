...
def download_sc_cw_children(
    ...
    corpus_dir = target_dir / "sc_cw_children"
    ...
    for split in splits:
        ...
        if output_dir is not None:
            supervision_set.to_file(
                output_dir / f"sc_cw_children_supervisions_{split}.jsonl.gz"
            )
            recording_set.to_file(output_dir / f"sc_cw_children_recordings_{split}.jsonl.gz")
